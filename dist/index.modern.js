import React__default, { createContext, useState, createElement, useContext, Fragment } from 'react';
import { ThemeUIProvider, Button, Image } from 'theme-ui';
...
var ChatContext = createContext(defaultProvider);
var ChatProvider = function ChatProvider(_ref) {
  ...
  return createElement(ThemeUIProvider, {
    theme: theme
  }, createElement(ChatContext.Provider, {
    value: values
  }, children));
};
...
var Path = function Path(props) {
  return React__default.createElement(motion.path, Object.assign({
    fill: 'transparent',
    strokeWidth: '3',
    stroke: 'hsl(0, 0%, 99%)',
    strokeLinecap: 'round'
...
var ToggleIconFilled = function ToggleIconFilled() {
  ...
  }), React__default.createElement(motion.path, {
...
function ChatWidgetContainer(props) {
  ...
  return createElement(Fragment, null, createElement(motion.iframe, {
  ...
  }, "Loading..."), createElement(motion.div, {
